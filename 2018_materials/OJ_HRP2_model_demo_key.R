...
r <- hrp2_Simulation(N=2000, years=20, rdt.det = 0, EIR=1/365, microscopy.use = 1, strains.0=2, fitness = 1)

###Now, lets make a second population with the same assumptions but with a big fitness advantage (fitness=2).
r2 <- hrp2_Simulation(N=2000, years=20, rdt.det = 0, EIR=1/365, microscopy.use = 1, strains.0=2, fitness = 2)
...
r3 <- hrp2_Simulation(N=2000, years=20, rdt.det = 0, EIR=1/365, microscopy.use = 1, strains.0=2, fitness = 1.05)
...
###No fitness advantage
r <- hrp2_Simulation(N=2000, years=20, rdt.det = 0, rdt.nonadherence = 0.2, EIR=1/365, microscopy.use = 0, strains.0=10, fitness = 1)

###Now, lets make a second population with the same assumptions but with a big fitness advantage (fitness=2).
r2 <- hrp2_Simulation(N=2000, years=20, rdt.det = 0, rdt.nonadherence = 0.2, EIR=1/365, microscopy.use = 0, strains.0=10, fitness = 2)
...
### Now, let's make a third population that may be closer to reality, a slight fitness advantage (fitness=1.05)
r3 <- hrp2_Simulation(N=2000, years=20, rdt.det = 0, rdt.nonadherence = 0.2, EIR=1/365, microscopy.use = 0, strains.0=10, fitness = 1.05)

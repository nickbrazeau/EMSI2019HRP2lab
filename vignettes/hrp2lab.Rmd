...
>
ret %>% 
  dplyr::filter(time < 365) %>% # this would be the first year
  ggplot(.) + ...
>  
...
One thing to consider is the "cost" of a missed infection (e.g. an individual with _hrp2_ deleted parasites that was misdiagnosed by RDT, a "false-negative"), which is not reflected in the incidence plot above. Let's look at that below ()
